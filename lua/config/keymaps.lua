...
map("n", "<leader>t2", function()
  _G._TERMINAL_2_TOGGLE()
end, { desc = "Terminal 2" })
map("n", "<leader>t3", function()
  _G._TERMINAL_3_TOGGLE()
end, { desc = "Terminal 3" })
map("n", "<leader>t4", function()
  _G._TERMINAL_4_TOGGLE()
end, { desc = "Terminal 4" })
map("n", "<leader>t5", function()
  _G._TERMINAL_5_TOGGLE()
end, { desc = "Terminal 5" })
map("n", "<leader>ts", function()
  require("toggleterm.terminal").Terminal:new({ cmd = "scooter", direction = "float" }):toggle()
