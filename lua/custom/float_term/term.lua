-- =============================================================================
--  custom/float_term/term.lua  ·  Floating terminal helper
--
--  Provides a lightweight floating terminal that can run any CLI tool.
--  Used by plugins/lazygit.lua to open lazygit in a centred float.
-- =============================================================================
