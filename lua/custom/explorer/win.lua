...
function M.ensure_hl()
  ...
  def("ExplorerSearchCursor",       { bg = blend(accent, sidebar_bg, 0.18) })
...
function M.reset_hl()
  ...
  local names = {
    "ExplorerNormal", "ExplorerCursorLine", "ExplorerDirectory", "ExplorerFile",
    "ExplorerFileAccent", "ExplorerConnector",
    ...
    "ExplorerSearchPlaceholder", "ExplorerSearchActiveText",
    "ExplorerSearchCount", "ExplorerSearchCountActive",
    "ExplorerSearchCursor", "ExplorerSearchMatch",
    "ExplorerWinbar", "ExplorerWinbarBranch",
    "ExplorerPopupNormal", "ExplorerPopupBorder", "ExplorerPopupTitle",
    "ExplorerPopupFooter", "ExplorerPopupPrompt", "ExplorerPopupValue",
    "ExplorerPopupDangerBorder", "ExplorerPopupDangerTitle",
