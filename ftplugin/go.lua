...
local _dbg_config_loaded = false
...
local function get_go_debugger()
  ...
  -- One-time global setup: registers GoDlv* commands, <leader>d* keymaps,
  -- session-scoped arrow/F-keys, highlights and signs.
  if not _dbg_config_loaded then
    _dbg_config_loaded = true
    local cfg_ok, cfg = pcall(require, "custom.go.debugger_config")
    if cfg_ok then
      cfg.setup()
    else
      mod.setup()
...
-- GoDlv* commands registered once globally (go.lua re-runs per buffer).
if not vim.g._go_dlv_cmds_registered then
  vim.g._go_dlv_cmds_registered = true
  ...
  vim.api.nvim_create_user_command("GoDlvLogpoint", function()
    with_go_debugger("logpoint")()
  end, { desc = "Set logpoint (no pause, logs a message)" })
  vim.api.nvim_create_user_command("GoDlvHitBreakpoint", function()
    with_go_debugger("hit_breakpoint")()
  ...
  vim.api.nvim_create_user_command("GoDlvRestart", function()
    with_go_debugger("restart")()
  ...
  vim.api.nvim_create_user_command("GoDlvPause", function()
    with_go_debugger("pause")()
  end, { desc = "Pause running program" })
  vim.api.nvim_create_user_command("GoDlvRunToCursor", function()
    with_go_debugger("run_to_cursor")()
  end, { desc = "Run to cursor line" })
  ...
  vim.api.nvim_create_user_command("GoDlvInspect", function(opts)
    with_go_debugger("inspect")(opts.args ~= "" and opts.args or nil)
  end, { nargs = "?", desc = "Inspect expression" })
  vim.api.nvim_create_user_command("GoDlvSetVar", function()
    with_go_debugger("set_variable")()
  end, { desc = "Set variable value at runtime" })
  vim.api.nvim_create_user_command("GoDlvHover", function()
    with_go_debugger("hover_eval")()
  end, { desc = "Hover-evaluate word under cursor" })
  vim.api.nvim_create_user_command("GoDlvWatch", function(opts)
    with_go_debugger("watch_add")(opts.args ~= "" and opts.args or nil)
  end, { nargs = "?", desc = "Add watch expression" })
  vim.api.nvim_create_user_command("GoDlvWatchRemove", function()
    with_go_debugger("watch_remove")()
  end, { desc = "Remove watch expression" })
...
go_map("<leader>tdR", with_go_debugger("restart"), "Restart last session")
...
go_map("<leader>tdL", with_go_debugger("logpoint"), "Logpoint (no pause)")
go_map("<leader>tdh", with_go_debugger("hit_breakpoint"), "Hit-count breakpoint")
go_map("<leader>tdr", with_go_debugger("remove_breakpoint"), "Remove breakpoint")
...
go_map("<leader>tdz", with_go_debugger("pause"), "Pause")
go_map("<leader>tdg", with_go_debugger("run_to_cursor"), "Run to cursor")
...
go_map("<leader>tdE", with_go_debugger("set_variable"), "Set variable value")
go_map("<leader>tdk", with_go_debugger("hover_eval"), "Hover eval (float)")
go_map("<leader>tdw", with_go_debugger("watch_add"), "Add watch expression")
go_map("<leader>tdW", with_go_debugger("watch_remove"), "Remove watch expression")
