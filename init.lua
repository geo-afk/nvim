...
loader.register({
  ...
  -- Project/Git, Explorer, Terminal.
  {
    ...
    cmd = "Tv",
    keys = {
      { "<leader>t", group = "Television", icon = { icon = "󰸍 ", hl = "MiniIconsGreen" } },
      { "<leader>tv", desc = "Channel picker" },
      { "<leader>ta", desc = "Shell aliases" },
      { "<leader>td", desc = "Directories" },
      { "<leader>tD", desc = "Docker images" },
      { "<leader>t.", desc = "Dotfiles" },
      { "<leader>te", desc = "Environment variables" },
      { "<leader>tf", desc = "Files" },
      { "<leader>tN", desc = "Nushell history" },
      { "<leader>tP", desc = "PowerShell history" },
      { "<leader>ts", desc = "Text search" },
      { "<leader>tT", desc = "TLDR pages" },
      { "<leader>gt", group = "Television", icon = { icon = "󰊢 ", hl = "MiniIconsOrange" } },
      { "<leader>gtb", desc = "Git branches" },
      { "<leader>gtd", desc = "Git diff" },
      { "<leader>gtl", desc = "Git log" },
      { "<leader>gtr", desc = "Git reflog" },
      { "<leader>gtR", desc = "Git repositories" },
    },
    config = function(tv)
      tv.setup()
    end,
